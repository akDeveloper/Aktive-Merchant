...
class PaypalTest extends \AktiveMerchant\TestCase
{
    ...
    {
        return "CREDITCARDTYPE=Visa&ACCT=4381258770269608&EXPDATE=01".(date('Y')+1)."&CVV2=000&FIRSTNAME=John&LASTNAME=Doe&CURRENCYCODE=USD&STREET=1234+Penny+Lane&CITY=Jonsetown&STATE=NC&ZIP=23456&COUNTRYCODE=US&PAYMENTACTION=Sale&AMT=100.00&IPADDRESS=10.0.0.1&METHOD=DoDirectPayment&VERSION=85.0&PWD=y&USER=x&SIGNATURE=z";
    }
    ...
    {
        return "CREDITCARDTYPE=Visa&ACCT=234234234234&EXPDATE=01".(date('Y')+1)."&CVV2=000&FIRSTNAME=John&LASTNAME=Doe&CURRENCYCODE=USD&STREET=1234+Penny+Lane&CITY=Jonsetown&STATE=NC&ZIP=23456&COUNTRYCODE=US&PAYMENTACTION=Sale&AMT=100.00&IPADDRESS=10.0.0.1&METHOD=DoDirectPayment&VERSION=85.0&PWD=y&USER=x&SIGNATURE=z";
    }
    ...
    {
        return "CREDITCARDTYPE=Visa&ACCT=234234234234&EXPDATE=01".(date('Y')+1)."&CVV2=000&FIRSTNAME=John&LASTNAME=Doe&CURRENCYCODE=USD&STREET=1234+Penny+Lane&CITY=Jonsetown&STATE=NC&ZIP=23456&COUNTRYCODE=US&PAYMENTACTION=Authorization&AMT=100.00&IPADDRESS=10.0.0.1&METHOD=DoDirectPayment&VERSION=85.0&PWD=y&USER=x&SIGNATURE=z";
    }
