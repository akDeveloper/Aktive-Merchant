...
/**
 * Description of Merchant_Billing_ePDQ
 *
...
class Merchant_Billing_ePDQ extends Merchant_Billing_Gateway {
    const GATEWAY_URL = 'https://secure2.mde.epdq.co.uk';
    const GATEWAY_PORT = 11500;
    const URL = GATEWAY_URL . GATEWAY_PORT;
  
    private $CARD_TYPE_MAPPINGS = array(
        'visa' => 1, 'master' => 2, 'american_express' => 8, 'discover' => 3
    );
    ...
    protected $money_format = 'dollars';
