...
class Merchant_Billing_HsbcSecureEpayments extends Merchant_Billing_Gateway {
  ...
  public  $supported_countries = array('US', 'GB');
  public  $supported_cardtypes = array('visa', 'master', 'american_express', 'switch', 'solo', 'maestro');
  public  $homepage_url = 'http://www.hsbc.co.uk/1/2/business/cards-payments/secure-epayments';
  public  $display_name = 'HSBC Secure ePayments';
  ...
  public function  __construct($options = array()) {
    ...
    $mode = $this->mode();
    if ( $mode == 'live' ) $this->payment_mode = 'P'; #Production mode
