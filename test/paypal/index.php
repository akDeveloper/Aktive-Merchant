...
try {
  ...
  if ( isset($_GET['pay']) ) {
    ...
    $response = $gateway->setup_purchase($_POST['amount'], array(
      'return_url' => 'http://localhost/merchant/test/paypal/index.php',
      'cancel_return_url' => 'http://localhost/merchant/test/paypal/index.php?cancel=1',
      )
    );
...
?>
<form method="post" action="/merchant/test/paypal/index.php?pay=1">
